<template>
  <!-- if done-->
  <div v-if='!this.nativePaymentLoading && this.booking.payment' class='flex flex-col flex-1 gap-4 w-full text-base text-left sm:my-8 sm:px-6 lg:px-8'>
...
export default {
  ...
  methods: {
    ...
    ...mapActions('booking', ['openNativePaymentAction', 'finishTimerAction']),
  },
}
